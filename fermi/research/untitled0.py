...
#make data smooth
daynew = np.linspace(1, 2922, 2923) 
...
def objective(day, a, b):
	return (a * day) + (b * day**2)
popt, _ = curve_fit(objective, day, number)
a, b = popt
x_line = np.arange(np.min(day), np.max(day),1)
# calculate the output for the range
y_line = objective(x_line, a, b)
# create a line plot for the mapping function
ax.plot(x_line, y_line,linewidth=2, label='fit: a=%5.3f, b=%5.3f' % tuple(popt),fillstyle='bottom')
ax.scatter(day, number,color='red', label='data')
...
ax.set_title('Count in bins, bins = 100',fontsize = 60)
...
cbar.set_label(" Average energy ( MeV )",fontsize=50) 
cbar.ax.tick_params(labelsize=40)  
ax0.set_title('Average energy in bins, bins = 100',fontsize = 60, horizontalalignment = 'center')
...
#z
z1 = t_mapp_3year0['ENERGY']
z2 = t_mapp_3year1['ENERGY']
z3 = t_mapp_3year2['ENERGY']
z4 = t_mapp_3year3['ENERGY']
z5 = t_mapp_3year4['ENERGY']
z6 = t_mapp_3year5['ENERGY']
z7 = t_mapp_3year6['ENERGY']
z8 = t_mapp_3year7['ENERGY']
z9 = t_mapp_3year8['ENERGY']
...
#z
z1 = t_mapp_5year0['ENERGY']
z2 = t_mapp_5year1['ENERGY']
z3 = t_mapp_5year2['ENERGY']
z4 = t_mapp_5year3['ENERGY']
z5 = t_mapp_5year4['ENERGY']
z6 = t_mapp_5year5['ENERGY']
z7 = t_mapp_5year6['ENERGY']
z8 = t_mapp_5year7['ENERGY']
z9 = t_mapp_5year8['ENERGY']
